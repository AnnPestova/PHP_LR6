...
{
    // объект класса DatabaseController для коннекта и работы с БД
    ...
    //подгрузка постов из БД для неавторизованного пользователя
    ...
    //подгрузка постов из БД для авторизованного пользователя
    ...
    //выход из аккаунта -- очистка сессии и кукис
    ...
    //показать больше постов на страницу неавторизованного пользователя
    ...
    //показать больше постов на страницу авторизованного пользователя
    ...
    //возвразащаем состояние пользователя -- авторизован / не авторизован
    ...
    # все посты пользователя для личного кабинета
