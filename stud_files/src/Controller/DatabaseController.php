...
class DatabaseController
{
    ...
    //получить начальные посты из БД
    ...
    //проверка, что телефон не занят другим пользователем
    ...
    //авторизация пользователя (достаем данные из БД и сверяем с тем, что имеется)
